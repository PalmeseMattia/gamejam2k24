    ...
    return (
        <main className='text-5xl flex flex-col items-center justify-center w-screen h-screen'>
            ...
            <div className='flex flex-row w-full justify-end'>
                ...
                Con un colpo mal mirato, la principessa Rosetta ha spezzato la magica corona del regno, che esplode distruggendo il salone.
                    <br/>Il pavimento crolla proprio sulla testa del povero Ditirello.
                    <br/>
                </p>
